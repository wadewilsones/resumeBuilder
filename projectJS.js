    ...
    function validateForm(){
       ...
       if (name.value == "" || role.value == "" || state.value == "" || zip.value == "" || state.value.length > 2 || city.value == "" || phone.value == ""){
        ...
        alert ("Please, fill out the required fields in the Skills section!");
         ...
         resumePage += ("<section class ='personal'><h3>Contacts<h3><br><ul><li>" + '<i class="fas fa-home"></i>' + city.value + ", " + state.value +", " + zip.value + "</li><li>"+'<i class="fas fa-phone"></i>' + phone.value + "</li><li>"+'<i class="far fa-envelope"></i>'+email.value+"</li><li>"+'<i class="fab fa-linkedin"></i>'+linkedin.value+"</li><li id ='website'>"+'<i class="fas fa-globe"></i>'+ website.value +"</li></section>");
         resumePage += ("<section class ='summaryRes'><h3>Profile</h3><p>"+ summary.value +"</p></section></div>"); // Profile section and end of container
         ...
         //Experience section
         resumePage += ("<section class = 'experience'><h3>Experience</h3><h4>"+position1.value+"</h4><ul><li>" + company1.value + " | " + startJobDate1.value + " - "+ endJobDate1.value + "</li></ul><p>"+details1.value+" "+"Reference: "+ reference1.value+"</p>");
         ...
         resumePage += ("<h4>"+position3.value+"</h4><ul><li>" + company3.value + " | " + startJobDate3.value + " - "+ endJobDate3.value + "</li></ul><p>"+details3.value+" "+"Reference: "+ reference3.value+"</p></section></div></main></body></html>");
